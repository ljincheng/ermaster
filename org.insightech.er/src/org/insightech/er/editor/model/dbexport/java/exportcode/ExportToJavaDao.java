...
public class ExportToJavaDao extends ExportToJavaTemplate{

	private   String TEMPLATE;
	private String exportFileName;
	
	public ExportToJavaDao(ExportJavaSetting exportJavaSetting){
		try {
			TEMPLATE = loadResource("groupcode/@dao");
	...
	public StringBuilder generateContent(ERDiagram diagram, ERTable table, String compositeIdClassName) throws IOException 
	{
		...
		exportFileName=table.getLogicalName()+"Dao";
