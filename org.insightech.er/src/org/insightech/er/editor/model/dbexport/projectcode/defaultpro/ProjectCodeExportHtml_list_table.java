 ...
 *
 */
public class ProjectCodeExportHtml_list_table extends ProjectCodeTemplate{

	private static final String TEMPLATE;

	static {
		try {
			TEMPLATE = ProjectCodeCommon.loadResource("@html_list_table");
		} catch (IOException e) {
			e.printStackTrace();
			throw new ExceptionInInitializerError(e);
		}
	}
	public ProjectCodeExportHtml_list_table(ProjectCodeSetting setting, ExportJavaSetting exportJavaSetting,
			ERDiagram diagram) {
...
//		content = this.replaceImportInfo(content);
	...
	public String getOutPath(ERTable table) {
		...
		return folderPath+ProjectCodeCommon.getCamelCaseName(this.getClassName(table),false,false)+"List_table.jsp";
	}
