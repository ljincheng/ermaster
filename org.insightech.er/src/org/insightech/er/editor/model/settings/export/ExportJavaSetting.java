...
public class ExportJavaSetting implements Serializable, Cloneable {
	...
	private boolean withBebeEntity;
	private boolean withIbatis;
	...
	public boolean isWithBebeEntity()
	{
		return withBebeEntity;
	}
	
	public boolean isWithIbatis()
	{
		return this.withIbatis;
	}
	...
	public void setWithBebeEntity(boolean withBebeEntity)
	{
		this.withBebeEntity=withBebeEntity;
	}
	
	public void setWithIbatis(boolean withIbatis)
	{
		this.withIbatis=withIbatis;
	}
	...
	public boolean equals(Object obj) {
		...
		if (withHibernate != other.withHibernate)
			return false;
		if (withBebeEntity != other.withBebeEntity)
			return false;
		return true;
	}
