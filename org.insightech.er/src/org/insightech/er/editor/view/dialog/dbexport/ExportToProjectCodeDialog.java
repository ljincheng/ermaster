...
import org.insightech.er.editor.model.dbexport.projectcode.ExportToProjectCodeWithProgressManager;
 ...
 *
 */
public class ExportToProjectCodeDialog extends AbstractDialog {
...
//	private Button withBebeEntityButton;
	...
	public ExportToProjectCodeDialog(Shell parentShell, ERDiagram diagram,
...
//		this.withBebeEntityButton = CompositeFactory.createCheckbox(this,
//				parent, "label.with.bebeentity", 3);
	}
...
//			boolean withBebeEntity = this.withBebeEntityButton.getSelection();
...
//			exportJavaSetting.setWithBebeEntity(withBebeEntity);
			IFile file = ((IFileEditorInput) editorPart.getEditorInput())
					.getFile();
			String fileName=file.getName();
			exportJavaSetting.setJavaFolder(fileName.substring(0, fileName.lastIndexOf(".")));
			ExportToProjectCodeWithProgressManager manager=new ExportToProjectCodeWithProgressManager(exportJavaSetting, diagram);
	...
	protected String getTitle() {
		return "dialog.title.export.projectCode";
	}
