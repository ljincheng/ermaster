...
import org.insightech.er.editor.model.settings.LogicalName2DescribeAction;
...
import org.insightech.er.editor.view.action.dbexport.ExportToProjectCodeAction;
...
public class ERDiagramPopupMenuManager extends MenuManager {
	...
	public ERDiagramPopupMenuManager(ActionRegistry actionRegistry,
		...
		displayMenu.add(this.getAction(LogicalName2DescribeAction.ID));
		...
		exportMenu.add(this.getAction(ExportToProjectCodeAction.ID));
		exportMenu.add(new GroupMarker("export"));

		this.add(exportMenu);

		this.add(new Separator());
//		this.add(this.getAction(LogicalName2DescribeAction.ID));
